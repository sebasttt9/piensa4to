...
export declare class DatasetsService {
    ...
    uploadDataset(ownerId: string, datasetId: string, file: Express.Multer.File, userRole?: string, organizationId?: string): Promise<DatasetEntity>;
    update(ownerId: string, datasetId: string, dto: Partial<UploadDatasetDto>, userRole?: string, organizationId?: string): Promise<DatasetEntity>;
    findAll(ownerId: string, userRole?: string, skip?: number, limit?: number, organizationId?: string): Promise<DatasetEntity[]>;
    countByUser(ownerId: string, userRole?: string, organizationId?: string): Promise<number>;
    findOne(ownerId: string, datasetId: string, userRole?: string, organizationId?: string): Promise<DatasetEntity>;
    getPreview(datasetId: string, limit?: number): Promise<Record<string, unknown>[]>;
    remove(ownerId: string, datasetId: string, userRole?: string, organizationId?: string): Promise<void>;
